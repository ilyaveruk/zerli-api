...
//        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000/api/v1/login" ,"http://localhost:3000/api/v1/users/save","http://localhost:3000/api/v1/users","http://localhost:3000/api/v1/flowers"));
